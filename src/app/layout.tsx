  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="instalaciones-electricas";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Instalaciones Electricas MURZAL SL. B-75455725"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="instalaciones-electricas"
          data-primary-color="#877a57"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="instalaciones-electricas";
